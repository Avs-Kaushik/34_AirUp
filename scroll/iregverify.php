...
{
mysqli_query($conn,"INSERT into investors(name,email,gender,dob,password,gov_id,iid) VALUES('$nm','$email','$gen','$dob','$pass','$gov','$iid')");
...
header("refresh:0.1;url=http://localhost/New%20Folder%20(3)/spotify.php");
}
else{
